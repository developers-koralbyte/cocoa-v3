    ...
    return (
        <nav className="h-16 flex justify-between items-center px-8 py-2 bg-primaryPurple shadow-lg">
            ...
            <div className="mt-10 flex space-x-8 items-center h-full">
                ...
                {/* Login Button */}
                <button className="bg-purple-700 text-white font-medium rounded-full px-4 py-2 h-full flex items-center justify-center hover:bg-purple-800 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all">
                    Log in
                </button>
            </div>
        </nav>
