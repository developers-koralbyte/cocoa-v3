...
const InvoiceTable = ({ invoices, selectedInvoices, onSelect }: InvoiceTableProps) => {
  return (
    <div>
        ...
        <div className="overflow-x-auto">
          ...
          <thead>
              <tr className="bg-[#D9D9D9]">
                ...
                <th className="p-2 pl-20 text-left font-nunito text-black w-48">Sender</th>
                  ...
                  <td className="p-4">
                    <span className={`px-4 py-1 rounded-full text-sm font-medium
                      ${invoice.status === 'Paid' ? 'bg-[#ECFDF3] text-[#027A48]' : 
                        invoice.status === 'Unpaid' ? 'bg-[#EFF8FF] text-[#175CD3]' :
