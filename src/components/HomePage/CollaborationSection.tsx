...
const CollaborationSection = () => {
  return (
      <section className="flex flex-col md:flex-row items-center justify-between px-1 md:px-28 py-2 bg-white ">
          ...
          <div className="mt-5 md:mt-20 text-center md:text-left max-w-xl">
              <h2 className="text-[50px] text-3xl font-bold text-gray-800 leading-[3.5rem] font-nunito">
                  Connect, chat,
                  <br className="pt-6 loading-6" /> collaborate and <br /> grow
                  with COCOA
              </h2>
              <p className="text[22px] mt-4 font-sourceSans">
                  Designed to revolutionize digital procurement and B2B <br />
                  communication through our innovative chat-based platform!{' '}
                  <br />
                  With instant messaging for enterprise procurement,
                  <br /> streamlined digital workflows, and seamless document
