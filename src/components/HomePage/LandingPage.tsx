        ...
        <div className="flex w-full min-h-screen items-center">
          ...
          <div className="w-1/2 pt-56 pl-28">
            <h1 className="font-nunito text-[75px] font-bold leading-[86px] text-left text-buttonBg">
              Real-Time Global <br /> Procurement <br /> Through Chat
            </h1>
            <div className="font-sourceSans">
              <p className="mt-4 text-[22px] text-buttonBg leading-relaxed">
                From enterprise-level corporate services and leading ERP
                solutions<br />
                (including NetSuite, SAP S/4HANA, Oracle) to commercial
                equipment <br />
                and food & beverage procurement, COCOA revolutionizes B2B{" "}
                <br /> purchasing by providing real-time communication with
                trusted <br />
              ...
              <p className="mt-6 text-[18px] font-bold text-buttonBg">
                ...
                connecting <br />
                businesses with verified suppliers through instant chat
                communication.
              </p>
            </div>
          ...
          <div className="w-1/2 flex items-center justify-end pt-56">
            <img src={laptopImage} alt="Laptop Display" className="h-auto w-auto" />
          </div>
        </div>
      </section>
    </>
