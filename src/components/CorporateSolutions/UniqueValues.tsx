                            ...
                            <div className="space-y-10">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-1 text-sm text-white/90">
                                            <p>Reduce onsite selection</p>
                                            <p>
                                                Close deals faster with direct
                                                communication
                                            </p>
                                            <p>Accelerate purchase cycles</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-1 text-sm text-white/90">
                                            <p>
                                                Direct to vendor/buyer
                                                communications
                                            </p>
                                            <p>
                                                Eliminate email chains, texts,
                                                phone calls from multiple
                                                platforms
                                            </p>
                                            <p>
                                                Convert discussion to
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-1 text-sm text-white/90">
                                            ...
                                            <p>Monitor vendor performance</p>
