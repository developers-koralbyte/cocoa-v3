            ...
            <div className="container mx-auto px-32">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-[#6B5BA9] max-w-3xl mx-auto">
                        From policy management to vendor verification, COCOA
                        provides a comprehensive platform that helps enterprises
                        manage complex procurement processes while ensuring
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-20">
                    ...
                    <div className="bg-[#B4EDE8] rounded-2xl p-3 aspect-[1.25] flex flex-col justify-end">
                        ...
                        <div className="space-y-1 text-sm text-[#2A4365]/80">
                            <p>Real-time chat with verified vendors</p>
                            <p>Document sharing in conversation</p>
                            <p>Instant response tracking</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#9F7AEA] rounded-2xl p-3 aspect-[1.25] flex flex-col justify-end">
                        ...
                        <div className="space-y-1 text-sm text-white/90">
                            ...
                            <p>Purchase order creation from chat</p>
                            <p>Payment milestone tracking</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#D6BCFA] rounded-2xl p-3 aspect-[1.25] flex flex-col justify-end">
                        ...
                        <div className="space-y-1 text-sm text-[#2A4365]/80">
                            ...
                            <p>Capability-based recommendations</p>
